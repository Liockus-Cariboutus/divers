...
VJ.AddNPC_HUMAN("Player NPC Allied", "npc_vj_test_player", {"weapon_vj_ak47", "weapon_vj_glock17", "weapon_vj_m16a1", "weapon_vj_mp40", "weapon_vj_9mmpistol", "weapon_vj_357", "weapon_vj_ar2", "weapon_vj_blaster", "weapon_vj_smg1", "weapon_vj_spas12", "weapon_vj_k3", "weapon_vj_crossbow", "weapon_vj_ssg08"}, spawnCategory)

-- ==== WEHRMACHT : DÉVOTION DES NATIONS /!\`==== --

VJ.AddNPC_HUMAN("Player NPC German", "npc_vj_player_heer_en", {""}, spawnCategory)
